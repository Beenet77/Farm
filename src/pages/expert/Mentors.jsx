  ...
  return (
    ...
    <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        <div class="w-full text-center pb-8">
            ...
            <p class="text-gray-400 font-normal text-base"> A soil expert, or soil scientist, specializes in studying, analyzing, and advising on soil properties and quality. They play a vital role in agriculture, land management, and environmental conservation.
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-gray-300 rounded-lg p-6">
                <div class=" bg-gray-300 flex items-center space-x-6 mb-4">
                    ...
                    src={Pic} alt="photo"/>
                    <div>
                        <p class="text-xl text-gray-700 font-normal mb-1 flex">Ram Thapa</p>
                        <p class="text-base text-blue-600 font-normal flex"> Soil Exports</p>
                    </div>
                </div>
                <div>
            ...
            <div class="bg-gray-300 rounded-lg p-6">
                <div class=" bg-grey flex items-center space-x-6 mb-4">
                    ...
                    src={Pic2} alt="photo"/>
                    <div>
                        <p class="text-xl text-gray-700 font-normal mb-1">Sita Khadka</p>
                        <p class="text-base text-blue-600 font-normal">Fertilizer Experts</p>
                    </div>
                </div>
                <div>
                    <p class="text-gray-400 leading-loose font-normal text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            ...
            <div class="bg-gray-300 rounded-lg p-6">
                <div class="flex items-center space-x-6 mb-4">
                    ...
                    src={Pic1} alt="photo"/>
                    <div>
                        <p class="text-xl text-gray-700 font-normal mb-1">Pushpa Adhaikari</p>
            ...
            <div class="bg-gray-300 rounded-lg p-6">
                <div class="flex items-center space-x-6 mb-4">
                  {/** Image photo */}
                    ...
                    src={Anil} alt="photo"/>
                    <div>
                        <p class="text-xl text-gray-700 font-normal mb-1">Anil Adhikari</p>
            ...
            <div class="bg-gray-300 rounded-lg p-6">
                <div class="flex items-center space-x-6 mb-4">
                    ...
                    src={Pic3} alt="photo"/>
                    <div>
                        <p class="text-xl text-gray-700 font-normal mb-1"> Anup Sapkota</p>
