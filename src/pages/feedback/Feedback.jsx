...
प्रतिक्रिया</h2>
                            ...
                            <div className="relative mb-4">
                                <label for="email" className="leading-7 text-sm text-gray-600">छोटकरीमा बताउनुहोस्</label>
                            ...
                            <div className="relative mb-4">
                                <label for="message" className="leading-7 text-sm text-gray-600">सन्देश</label>
...
हाम्रो टोलीले सकेसम्म चाँडो जवाफ दिनेछ।</p>
                        </form>
                    </div>
                </section>
            </div>
