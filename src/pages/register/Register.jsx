...
const Register = () => {
    ...
    let handelUserRegister=async(e)=>{
          e.preventDefault();
         let result=await fetch('http://localhost:8000/accounts/register/',{
                mode: 'no-cors',
                 method:'POST',
                 headers:{
    ...
    return (
        <div>
            <section className="relative flex flex-wrap lg:h-screen lg:items-center bg-[#0F2B05]">
                <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-8 bg-white">
                    ...
                    <form action="" method='POST' onSubmit={handelUserRegister} className="mx-auto mt-8 mb-0 max-w-md space-y-4">
