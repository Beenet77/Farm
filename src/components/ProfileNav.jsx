  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 text-black">
      <Typography
        ...
        variant="small"
        color="blue-gray"
        className={`flex items-center gap-x-2 p-6 rounded-lg font-medium ${
          tab === "YOUR_PRODUCTS" && "bg-green-800 text-white"
        } `}
      >
        <svg
          width="16"
      ...
      <Typography
        ...
        color="blue-gray"
        className={`flex items-center gap-x-2 p-6 rounded-lg font-medium ${
          tab === "ORDERS" && "bg-green-800 text-white"
        } `}
      >
        <svg
          width="14"
        ...
        <Link onClick={() => setTab("ORDERS")} className="flex items-center">
          Orders
        </Link>
      </Typography>
      <Typography
        ...
        color="blue-gray"
        className={`flex items-center gap-x-2 p-6 rounded-lg font-medium ${
          tab === "SETTING" && "bg-green-800 text-white"
        } `}
      >
        <svg
          width="16"
        ...
        <Link onClick={() => setTab("SETTING")} className="flex items-center">
          Setting
        </Link>
      </Typography>
    </ul>
